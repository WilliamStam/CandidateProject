...
class Pagination {
    ...
    public function calculate($total_rows, $page_num) {
        ...
        $arr['pages'] = $this->getSurroundingPages($page_num,$last_page,$arr['next'],$this->page_blocks);
    ...
    private function getSurroundingPages($page_num, $last_page, $next, $amount_of_blocks) {
        $arr = array();
        $show = $amount_of_blocks; // how many boxes
